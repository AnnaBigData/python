# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 12:08:07 2021
...
class Clothes:
    ...
    def __init__(self, height, lengh):
        self.height = height
        self.lengh = lengh
        
    @property 
    def cloak(self):
         return f"расход на пальто: {round(self.height / 6.5 + 0.5)}"
    
    @property
    def suit(self):
         return f"расход на костюм: {round(self.lengh * 2 + 0.3)}"
     
    @property
    def __add__(self):
       return f"Общий: {round(self.height / 6.5 + 0.5) + round(self.lengh * 2 + 0.3)}"
